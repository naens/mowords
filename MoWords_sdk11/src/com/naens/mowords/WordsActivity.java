...
//	private String theme;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		boolean showDraw = sharedPref.getBoolean(SettingsActivity.getShowDrawKey(folderName), false);
		if (showDraw) {
...
//		}
	...
	public void askSecondSide(List<Integer> firstSideTimes, List<Integer> firstSideCorrects) {
		...
		alertbox.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
			public void onClick(DialogInterface arg0, int arg1) {
				DrawView dw = (DrawView) findViewById(R.id.draw_view);
				if (dw != null && dw.getVisibility() == View.VISIBLE) {
					dw.clear();
				}
				wg.askSecondSideYes();
			}
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		boolean showDraw = sharedPref.getBoolean(SettingsActivity.getShowDrawKey(folderName), false);
		MenuItem clear = (MenuItem) menu.findItem(R.id.action_clear);
		if (showDraw) {
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		switch (item.getItemId()) {
	        ...
	        case R.id.action_draw:
				...
				editor.putBoolean(SettingsActivity.getShowDrawKey(folderName), showDraw); 
				editor.commit();
	            return true;
