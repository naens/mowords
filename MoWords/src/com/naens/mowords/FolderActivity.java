...
public class FolderActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		oneDirConf = MainActivity.getConfigurationDAO().isOneDirection(folderName);
		...
		String [] lims = MainActivity.getConfigurationDAO().getLimitList(folderName);
		String defLimit = MainActivity.getConfigurationDAO().getDefaultLimit(folderName);
