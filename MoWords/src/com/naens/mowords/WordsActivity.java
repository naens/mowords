...
//		wordView.setMovementMethod(new ScrollingMovementMethod());
	...
	private void loadTheme() {
    	...
    	if (theme.equals("Light")) {
    		...
    		((TextView) findViewById(R.id.words_status_view)).setTextColor(getResources().getColor(android.R.color.secondary_text_light));
    		((TextView) findViewById(R.id.words_time_view)).setTextColor(getResources().getColor(android.R.color.secondary_text_light));
    	}
    	if (theme.equals("Dark")) {
    		...
    		((TextView) findViewById(R.id.words_status_view)).setTextColor(getResources().getColor(android.R.color.secondary_text_dark));
    		((TextView) findViewById(R.id.words_time_view)).setTextColor(getResources().getColor(android.R.color.secondary_text_dark));
    	}
	}
	...
	public void displayWord (Word word, boolean correct) {
		...
		//display buttons
//		((Button) findViewById(R.id.words_up_button)).setBackgroundResource(wg.isFirstWord() ? R.drawable.bwvstop : R.drawable.bwup);
//		((Button) findViewById(R.id.words_down_button)).setBackgroundResource(wg.isLastWord() ? R.drawable.bwvstop : R.drawable.bwdn);
//		((Button) findViewById(R.id.words_left_button)).setBackgroundResource(wg.isFirstSide() ? R.drawable.bwhstop : R.drawable.bwlt);
//		((Button) findViewById(R.id.words_right_button)).setBackgroundResource(wg.isLastSide() ? R.drawable.bwhstop : R.drawable.bwrt);
	}
	...
	public boolean onOptionsItemSelected(MenuItem item) {
	    ...
	    switch (item.getItemId()) {
	        case R.id.menu_settings:
	    	    ...
	    	    intent.putExtra(WORD_SIDE, wg.getSide () + 1);
